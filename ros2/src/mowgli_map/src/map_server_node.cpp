...
{
  // Use GridMapRosConverter for correct coordinate mapping.
  // The converter applies nCells-index-1 reversal which matches the
  // OccupancyGrid convention (row 0 = bottom of map).
